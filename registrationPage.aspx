...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="auto-style1">
        ...
        <asp:TextBox runat="server" ID="txt_fullname" placeholder="Enter fullname" Height="12px"></asp:TextBox>
        ...
        <asp:TextBox runat="server" ID="txt_emailid" placeholder="Enter Email ID" Height="12px"></asp:TextBox>
        ...
        <asp:TextBox runat="server" ID="txt_password" TextMode="Password" Height="12px" placeholder="Enter Password"></asp:TextBox>
        <asp:RequiredFieldValidator runat="server" ControlToValidate="txt_password"
            ErrorMessage="Please enter password"
            Display="None"></asp:RequiredFieldValidator>

        <label for="psw"><b>Re-enter Password</b></label>
        <asp:TextBox runat="server" ID="txt_repassword" TextMode="Password" Height="12px" placeholder="Re-enter password"></asp:TextBox>
