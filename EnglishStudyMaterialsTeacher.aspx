<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="EnglishStudyMaterialsTeacher.aspx.cs" Inherits="teachingPlatform.EnglishStudyMaterialsTeacher" %>
    ...
    <div>
        <div class="text-white" style="padding-top:50px; height:100%; width:100%; background-image: linear-gradient(to bottom, #1a6be4, #2870e9, #3274ee, #3c79f3, #447ef8, #4b89fb, #5493fd, #5e9dff, #71aeff, #87beff, #9fcdff, #b9dcff); box-shadow: 0px 0px 40px 40px #B6DCFF">
           <div style="padding-left:100px; font-family: 'Inter', sans-serif;">
                <h1>English Study Materials</h1>
                <div style="float:right; height: 45%; width: 45%; flex-wrap: wrap">
                    <asp:Image ID="Image1" runat="server" ImageUrl="~/Images/clip-schoolteacher-near-the-blackboard.png" Height="100%" Width="100%" style="float: right;" />
                </div>
                <br />
                <div>
