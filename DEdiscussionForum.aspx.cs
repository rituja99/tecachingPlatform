...
namespace teachingPlatform
{
    public partial class DEdiscussionForum : System.Web.UI.Page
    {
        ...
        protected void Fill_Page()
        {
            ...
            string cmdstr = "Select count(*) as count from DEDiscussion";
            ...
            try
            {
                ...
                {
                    reader.Close();
                    cmd.CommandText = "Select * from DEDiscussion";
                    dataAdapter = new SqlDataAdapter(cmd);
                    dataAdapter.Fill(set, "deDiscuss");
            ...
            finally
            {
                ...
                if (n > 0)
                {
                    ...
                    foreach (DataRow row in set.Tables["deDiscuss"].Rows)
                    {
                        label[i] = new Label();
        ...
        {
            SqlConnection con = new SqlConnection(connstr);
            string cmdstr = "insert into DEDiscussion (QUserName, Question, Answer, AUserName)" +
